...
<div style="float: left; width: 50%;">
  <figure>
  <img src="videosymbol.svg" width = 300px>
    <figcaption style="font-size: small; text-align: center; margin-top: 5px">Link zur umfassenden Präsentation folgt im Beitragsband</figcaption>
  </figure>
</div>
...
<div style="width: 100%;">
```{r echo=TRUE, message=FALSE, warning=FALSE, out.width="100%", eval=FALSE, cache=FALSE}
...
```{r eval=FALSE, results='hide', fig.keep='all', out.width="80%", warning=FALSE, cache=FALSE}
...
<center>
  <figure>
  <img src="person_ll_cowplot.svg" width = 80% class="center">
  <figcaption style="font-size: small; text-align: center; margin-top: 5px;"></figcaption>
  </figure>

```{r}
# include_graphics("person_ll_cowplot.svg")
```

```{r eval=FALSE, message=FALSE, out.width="80%", cache=FALSE}
