...
```{r}
respfuncdata_1d_1pl_tina <- calc_personresponsedata(fit_1d_1pl_tina1, post_responses =  posterior_responses_tina_1pl)
...
```{r}
ppmc_data_spm_1pl <- fit_1d_1pl_spm_full1 %>% get_ppmcdatasets(ppmcMethod = 'C', post_responses = posterior_responses_spm_1pl)
ppmc_data_spm_1pl_ll <- get_ppmccriteria(ppmcdata = ppmc_data_spm_1pl, ppmcMethod = 'C', crit = ll) # fix this
